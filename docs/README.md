...
| [tag-creator](../docs/reusable//tag-creator.md)              | Creates a new tag in the repository. (**DEPRICATED**)     |
...
| [tag-checker](../actions/tag-checker/README.md)         | Verifies the presence of specific tags in the repository. (**DEPRICATED**)       |
